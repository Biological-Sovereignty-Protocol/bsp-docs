...
Control of your BEO is determined by a **private key (Ed25519)** stored securely in your device's hardware enclave (e.g., Apple Secure Enclave). Access control rules (ConsentTokens) execute as Move modules on Aptos, making them mathematically immune to unauthorized access.
